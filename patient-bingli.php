			...
			<blockquote class="layui-elem-quote">
                <?php
					...
					if($result&&$result->num_rows>0)
						...
						<form class=\"layui-form\" name=\"inputForm\" method=\"get\" action=\"patient-bingliquery.php\">
							<div class=\"layui-form-item\">
								<label class=\"layui-form-label\">挂号单ID</label>
								<div class=\"layui-input-block\">
									<input type=\"text\" name=\"regID\" required lay-verify=\"number\" placeholder=\"请输入挂号单ID（病历单ID）\" autocomplete=\"off\" class=\"layui-input\" />
								</div>
							</div>";
