				...
				<table lay-filter="resultTable">
					<thead>
						<tr>
							...
							<th lay-data="{field:'doctorName',sort:true}">医生姓名</th>
					...
					<tbody>
						...
						$sql="select surg_pk,surg_sheet_no, surg_name, room_no, d_name, p_no, surg_begin_time, surg_end_time from SURGERY_SHEET a, SURGERY_ITEM b, DOCTOR c where a.surg_no=b.surg_no and a.phy_no=c.d_no";
						if($surgeryID!="")$sql.=" and surg_pk=$surgeryID";
						// echo $sql;
