			...
			<blockquote class="layui-elem-quote">
                <?php
					...
					if($result&&$result->num_rows>0)
						...
						<form class=\"layui-form\" name=\"inputForm\" method=\"post\" action=\"patient-medicalfeequery.php\">
							<div class=\"layui-form-item\">
								<label class=\"layui-form-label\">病历单ID</label>
								<div class=\"layui-input-block\">
									<input type=\"text\" name=\"formID\" required lay-verify=\"number\" placeholder=\"请输入病历单ID（挂号单ID）\" autocomplete=\"off\" class=\"layui-input\" />
								</div>
							</div>";
