			...
			<blockquote class="layui-elem-quote">
				<?php
					...
					if($result&&$result->num_rows>0)
						...
						echo "<form class=\"layui-form\" name=\"inputForm\" method=\"post\" action=\"doctor-jianyanquery.php\">";
						echo "<div class=\"layui-form-item\">
								<label class=\"layui-form-label\">处方单ID</label>
								<div class=\"layui-input-block\">
									<input type=\"text\" class=\"layui-input\" name=\"cfID\" required lay-verify=\"required\" placeholder=\"请输入安排检验的处方单ID\" autocomplete=\"off\" />
								</div>
							</div>";
						echo "<div class=\"layui-form-item\">
								<label class=\"layui-form-label\">项目ID</label>
								<div class=\"layui-input-inline\">
									<input type=\"text\" class=\"layui-input\" name=\"jyID\" placeholder=\"请输入安排的检验项目ID\" autocomplete=\"off\" />
								</div>
								<label class=\"layui-form-label\">项目名称</label>
								<div class=\"layui-input-inline\">
									<input type=\"text\" class=\"layui-input\" name=\"jyName\" placeholder=\"请输入安排的检验项目名称\" autocomplete=\"off\" />
								</div>
							</div>";
