			...
			<blockquote class="layui-elem-quote">
				<?php
					...
					if($result&&$result->num_rows>0)
						...
						echo "<form class=\"layui-form\" name=\"inputForm\" method=\"get\" action=\"doctor-chufangquery.php\">";
						echo "<div class=\"layui-form-item\">
								<label class=\"layui-form-label\">挂号单ID</label>
								<div class=\"layui-input-block\">
									<input type=\"text\" class=\"layui-input\" name=\"regID\" required lay-verify=\"required\" placeholder=\"请输入与处方单相关的挂号单ID\" autocomplete=\"off\" />
								</div>
