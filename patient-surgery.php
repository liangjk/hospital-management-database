			...
			<blockquote class="layui-elem-quote">
                <?php
					...
					if($result&&$result->num_rows>0)
						...
						echo "<form class=\"layui-form\" name=\"inputForm\" method=\"post\" action=\"patient-surgeryquery.php\">";
						echo "<div class=\"layui-form-item\">
								<label class=\"layui-form-label\">开始日期</label>
								<div class=\"layui-input-inline\">
									<input type=\"text\" class=\"layui-input\" name=\"beginTime\" id=\"beginTime\" required lay-verify=\"required\" placeholder=\"请选择查询开始时间\" autocomplete=\"off\" />
								</div>
								<label class=\"layui-form-label\">结束日期</label>
								<div class=\"layui-input-inline\">
									<input type=\"text\" class=\"layui-input\" name=\"endTime\" id=\"endTime\" required lay-verify=\"required\" placeholder=\"请选择查询结束时间\" autocomplete=\"off\" />
								</div>
								<input type=\"text\" name=\"patientID\" value=\"$patientID\" style=\"display:none;\" />
							</div>";
						echo "<div class=\"layui-form-item\">
