			...
			<blockquote class="layui-elem-quote">
				<?php
					...
					if($result&&$result->num_rows>0)
						...
						echo "<form class=\"layui-form\" name=\"inputForm\" method=\"post\" action=\"doctor-jianchaquery.php\">";
						echo "<div class=\"layui-form-item\">
								<label class=\"layui-form-label\">处方单ID</label>
								<div class=\"layui-input-block\">
									<input type=\"text\" class=\"layui-input\" name=\"cfID\" required lay-verify=\"required\" placeholder=\"请输入安排检查的处方单ID\" autocomplete=\"off\" />
								</div>
							</div>";
						echo "<div class=\"layui-form-item\">
								<label class=\"layui-form-label\">项目ID</label>
								<div class=\"layui-input-inline\">
									<input type=\"text\" class=\"layui-input\" name=\"jcID\" placeholder=\"请输入安排的检查项目ID\" autocomplete=\"off\" />
								</div>
								<label class=\"layui-form-label\">项目名称</label>
								<div class=\"layui-input-inline\">
									<input type=\"text\" class=\"layui-input\" name=\"jcName\" placeholder=\"请输入安排的检查项目名称\" autocomplete=\"off\" />
								</div>
							</div>";
						echo "<input type=\"text\" name=\"doctorID\" value=\"$doctorID\" style=\"display:none;\" />";
						echo "<div class=\"layui-form-item\">
								<div class=\"layui-input-block\">
									<button class=\"layui-btn\" lay-submit>确认安排</button>
