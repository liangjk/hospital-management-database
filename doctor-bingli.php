			...
			<blockquote class="layui-elem-quote">
				<?php
					...
					if($result&&$result->num_rows>0)
						...
						echo "<form class=\"layui-form\" name=\"inputForm1\" method=\"get\" action=\"doctor-bingliquery.php\">";
						echo "<div class=\"layui-form-item\">
								<label class=\"layui-form-label\">患者ID</label>
								<div class=\"layui-input-block\">
									<input type=\"text\" class=\"layui-input\" name=\"patientID\" required lay-verify=\"required\" placeholder=\"请输入查看病历的患者ID\" autocomplete=\"off\" />
								</div>
								<input type=\"text\" name=\"doctorID\" value=\"$doctorID\" style=\"display:none;\" />
							</div>";
						echo "<div class=\"layui-form-item\">
								<div class=\"layui-input-block\">
									<button class=\"layui-btn\" lay-submit>确认查看</button>
									<button type=\"reset\" class=\"layui-btn layui-btn-primary\">重置</button>
								</div>
							</div>";
						echo "</form>";
						echo "</blockquote><blockquote class=\"layui-elem-quote\">";
						echo "<form class=\"layui-form\" name=\"inputForm2\" method=\"get\" action=\"doctor-binglicontent.php\">";
						echo "<div class=\"layui-form-item\">
								<label class=\"layui-form-label\">处方单ID</label>
								<div class=\"layui-input-block\">
									<input type=\"text\" class=\"layui-input\" name=\"formID\" required lay-verify=\"required\" placeholder=\"请输入查看的病历处方单ID\" autocomplete=\"off\" />
								</div>
								<input type=\"text\" name=\"doctorID\" value=\"$doctorID\" style=\"display:none;\" />
							</div>";
						echo "<div class=\"layui-form-item\">
