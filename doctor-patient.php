			...
			<blockquote class="layui-elem-quote">
				<?php
					...
					if($result&&$result->num_rows>0)
						...
						echo "<form class=\"layui-form\" name=\"inputForm\" method=\"post\" action=\"doctor-patientquery.php\">";
						echo "<div class=\"layui-form-item\">
								<label class=\"layui-form-label\">患者ID</label>
								<div class=\"layui-input-block\">
									<input type=\"text\" name=\"patientID\" placeholder=\"请输入查询患者ID，默认查询全部与您相关的患者\" autocomplete=\"off\" class=\"layui-input\" />
